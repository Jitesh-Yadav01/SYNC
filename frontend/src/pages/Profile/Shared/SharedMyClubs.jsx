    ...
    if (clubs.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-20 px-4 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="w-16 h-16 bg-gdg-blue/10 text-gdg-blue rounded-full flex items-center justify-center mb-6 shadow-sm border border-blue-100">
                                    ...
                                    >
                                        <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                            <div className="flex items-center gap-3">
                                                <div className="h-8 w-8 rounded-full bg-blue-100 text-[#3367d6] flex items-center justify-center font-bold">
                                                    {clubName.charAt(0)}
                                                </div>
                                                {clubName}
                                            </div>
                                        ...
                                        <td className="px-6 py-4 text-right flex justify-end items-center gap-2">
                                            ...
                                            <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-gdg-blue transition-colors" />
                                        </td>
                                    </tr>
                                );
                            })}
